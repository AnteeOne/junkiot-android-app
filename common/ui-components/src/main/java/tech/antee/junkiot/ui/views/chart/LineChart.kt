...
fun LineChart(
    ...
    graphColor: Color = MaterialTheme.colorScheme.onSurface,
    ...
    Canvas(modifier = modifier) {
        ...
        if (isLabelsEnabled) {
            ...
            val valueStep = (upperValue - lowerValue) / 5f
            (0..4).forEach { i ->
                drawContext.canvas.nativeCanvas.apply {
                    drawText(
                        round(lowerValue + valueStep * i).toString(),
                        30f,
...
@Preview
@Composable
private fun LineChartPreview() = JunkiotTheme {
